...
echo "+--------------------------------------------------------------------------+"
echo ""
echo "NOTE: inspect the extracted information for compatibility with OpenCPN and system:"
echo "      - if there is more than one library installed, see opencpn.log which is used ;"
