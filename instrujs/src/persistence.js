...
export function saveObj( cid, cobj ) {
...
export function saveParam( cname, cid, cvalue, inexdays ) {
...
export function getParam( cname, cid ) {
...
export function deleteParam( cname, cid ) {
