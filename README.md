...
Canne's Github account is CLOSED. This link is dead.
...
_DashT_ [v1.5.11](https://github.com/canne/dashboard_tactics_pi/releases/tag/v1.5.11) DEAD now use [v1.5.11 in rgleason repo](https://github.com/rgleason/dashboard_tactics_pi/releases/tag/v1.5.11) was a forerunner in diversifying the data connectivity of a OpenCPN plug-in to enable direct network connections to resources available in a modern boat's computer and network infrastructure. This version, of which you can find installation packages in [Releases](https://github.com/canne/dashboard_tactics_pi/releases) (Dead link) continues this philosophy and presents new features by collecting timestamped open data and making it available to external applications and data retrieval systems.
