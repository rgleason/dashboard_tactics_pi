...
{
    // cf.  https://git.io/Jep2E
    switch( id ) {
    case 1 << 0:
        return _T("navigation.position.latitude");
    case 1 << 1:
        return _T("navigation.position.longitude");
    case 1 << 2:
        return _T("navigation.speedOverGround");
    case 1 << 3:
        return _T("navigation.courseOverGroundTrue");
    case 1 << 4:
        return _T("navigation.speedThroughWater");
    case 1 << 5:
        return _T("navigation.headingMagnetic");
    case 1 << 6:
        return _T("navigation.headingTrue");
    case 1 << 7:
        return _T("navigation.magneticVariation");
    case 1 << 8:
        return _T("navigation.courseRhumbline.nextPoint.bearingTrue");
    case 1 << 9:
        return _T("environment.wind.angleApparent");
    case 1 << 10:
        return _T("environment.wind.speedApparent");
    case 1 << 11:
        return _T("environment.wind.directionTrue");
    case 1 << 12:
        return _T("environment.wind.speedTrue");
    case 1 << 13:
        return _T("environment.depth.belowTransducer");
    case 1 << 14:
        return _T("environment.water.temperature");
    case 1 << 15:
        return _T("navigation.courseRhumbline.nextPoint.velocityMadeGood");
    case 1 << 16:
        return _T("steering.rudderAngle");
    case 1 << 17:
        return _T("navigation.gnss.satellites");
    case 1 << 18:
        return wxEmptyString;
    case 1 << 19:
        return wxEmptyString;
    case 1 << 20:
        return wxEmptyString;
    case 1 << 21:
        return _T("navigation.datetime");
    case 1 << 22:
        return wxEmptyString;
    case 1 << 23:
        return _T("environment.outside.temperature");
    case 1 << 24:
        return _T("environment.outside.temperature");
    case 1 << 25:
        return wxEmptyString;
    case 1 << 26:
        return _T("navigation.trip.log");
    case 1 << 27:
        return _T("navigation.log");
    case 1 << 28:
        return _T("environment.outside.pressure");
    case 1 << 29:
        return _T("navigation.courseOverGroundMagnetic");
    case 1 << 30:
        return _T("navigation.attitude.pitch");
    case 1ULL << 31:
        return _T("navigation.attitude.roll");
    case 1ULL << 32:
        return _T("performance.leeway");
    case 1ULL << 33:
        return _T("environment.current.setTrue");
    case 1ULL << 34:
        return _T("environment.current.drift");
    case 1ULL << 35:
        return wxEmptyString;
    case 1ULL << 36:
        return wxEmptyString;
    case 1ULL << 37:
        return _T("performance.polarSpeedRatio");
    case 1ULL << 38:
        return _T("performance.polarSpeed");
    case 1ULL << 39:
        return _T("performance.velocityMadeGood");
    case 1ULL << 40:
        return _T("performance.velocityMadeGoodToWaypoint");
    case 1ULL << 41:
        return wxEmptyString;
    case 1ULL << 42:
        return wxEmptyString;
...
unsigned long long getInstruIdEquivalent( wxString skkey )
{
    if ( skkey.IsEmpty() )
        return ULLONG_MAX;
    for ( int i = 0; i < 64; i++ ) {
        unsigned long long retval = 1ULL << i;
        if ( getSkEquivalentOfInstruId( retval ).CmpNoCase( skkey ) == 0 )
            return retval;
    } // While max. number of Dashboard _STC_ keys
    return ULLONG_MAX;
}
