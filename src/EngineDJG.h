...
#define ENGINEDJG_V_WIDTH    225
#define ENGINEDJG_V_HEIGHT   174
#define ENGINEDJG_V_BOTTOM     8
#define ENGINEDJG_H_TITLEH    19
#define ENGINEDJG_H_WIDTH    245
#define ENGINEDJG_H_HEIGHT   172
...
#endif // __ENGINEDJG_DERIVEDTIMEOUT_OVERRIDE__
