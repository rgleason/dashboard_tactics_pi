...
void TacticsPreferencesDialog::TacticsPreferencesPanel()
{
    ...
    m_alphaLaylineDampFactor = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0.025, 1, g_dalphaLaylinedDampFactor, 0.001);
    ...
    m_alphaDeltCoG = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0.025, 1, g_dalphaDeltCoG, 0.001);
    ...
    m_pLaylineLength = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0.0, 20.0, g_dLaylineLengthonChart, 0.1);
    ...
    m_minLayLineWidth = new wxSpinCtrl(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 20, g_iMinLaylineWidth);
    ...
    m_maxLayLineWidth = new wxSpinCtrl(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 30, g_iMaxLaylineWidth);
    ...
    m_LeewayFactor = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 20, g_dLeewayFactor, 0.01);
    ...
    m_fixedLeeway = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 30, g_dfixedLeeway, 0.01);
    ...
    m_heel5_45 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[1][1], 0.1);
    itemFlexGridSizer07->Add(m_heel5_45, 0, wxALIGN_LEFT, 0);
    m_heel5_45->SetValue(g_dheel[1][1]);
    //--------------------
    m_heel5_90 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[1][2], 0.1);
    itemFlexGridSizer07->Add(m_heel5_90, 0, wxALIGN_LEFT, 0);
    m_heel5_90->SetValue(g_dheel[1][2]);
    //--------------------
    m_heel5_135 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[1][3], 0.1);
    ...
    m_heel10_45 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[2][1], 0.1);
    itemFlexGridSizer07->Add(m_heel10_45, 0, wxALIGN_LEFT, 0);
    m_heel10_45->SetValue(g_dheel[2][1]);
    //--------------------
    m_heel10_90 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[2][2], 0.1);
    itemFlexGridSizer07->Add(m_heel10_90, 0, wxALIGN_LEFT, 0);
    m_heel10_90->SetValue(g_dheel[2][2]);
    //--------------------
    m_heel10_135 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[2][3], 0.1);
    ...
    m_heel20_45 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[4][1], 0.1);
    itemFlexGridSizer07->Add(m_heel20_45, 0, wxALIGN_LEFT, 0);
    m_heel20_45->SetValue(g_dheel[4][1]);
    //--------------------
    m_heel20_90 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[4][2], 0.1);
    itemFlexGridSizer07->Add(m_heel20_90, 0, wxALIGN_LEFT, 0);
    m_heel20_90->SetValue(g_dheel[4][2]);
    //--------------------
    m_heel20_135 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[4][3], 0.1);
    ...
    m_heel25_45 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[5][1], 0.1);
    itemFlexGridSizer07->Add(m_heel25_45, 0, wxALIGN_LEFT, 0);
    m_heel25_45->SetValue(g_dheel[5][1]);
    //--------------------
    m_heel25_90 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[5][2], 0.1);
    itemFlexGridSizer07->Add(m_heel25_90, 0, wxALIGN_LEFT, 0);
    m_heel25_90->SetValue(g_dheel[5][2]);
    //--------------------
    m_heel25_135 = new wxSpinCtrlDouble(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS, 0, 60, g_dheel[5][3], 0.1);
    ...
    m_AlphaCurrDir = new wxSpinCtrl(itemPanelNotebook03, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(110, -1), wxSP_ARROW_KEYS | wxSP_WRAP, 1, 400, g_dalpha_currdir * 1000);
